...
const Notification = () => {
  const notifications = [
    ...
    },
    {
      ...
      detail: "tasks which are left",
      dateTime: "2024-05-13T12:30:00Z", // Yesterday's date
    },
    {
      message: "Today Task",
  ...
  const [comingNotifications, setComingNotifications] = useState([]);
  ...
  const sortNotification = () => {
    ...
    setComingNotifications(comingNotifications);
  };
      ...
      <div className="w-full h-full flex">
        ...
        >
          <div className="w-[90%] rounded border">
            ...
            <h1 className="mt-5 text-[#9A9EA5] text-2xl">Previous</h1>
            <div>
            ...
            <h1 className="mt-5 text-[#9A9EA5] text-2xl">Coming Days</h1>
            <div>
              {comingNotifications.map((notification, index) => {
                return (
                  <div key={index} className=" mt-3 ml-8 flex gap-x-3">
                    <svg
                      width="48"
